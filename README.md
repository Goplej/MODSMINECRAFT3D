...
Готовый мод находится в `build/libs/upgradermod-1.20.1-1.0.0.jar`. Архив исходников
`upgradermod.zip` содержит проект без `.git`, кэшей Gradle и результатов сборки.
